...
% initialization
% get the initial X_iter and S_book_keeping structure
[X_iter,S_book_keeping] = WAn(Bobs);
...
for i=1:MAXITER
   ...
   t_old=t_new;
    ...
    WX_iter = WSy(X_iter, S_book_keeping);
...
%X_out=X_iter;
X_out=WSy(X_iter, S_book_keeping);
