function [x] = extension_adjoint_2d(xe, lX, le, extmode)
% extension_adjoint_2d - adjoint of 2d signal extension operator
% 
% x = extension_adjoint_2d(xe, lX, le, extmode) applies the adjoint of the 2d
